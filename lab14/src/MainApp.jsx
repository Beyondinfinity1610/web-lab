...
const StyledText = () => (
  <p style={{ color: "blue", fontWeight: "bold" }}>This is a styled message.</p>
);
...
const ShowDay = () => (
  <p>Today is {new Date().toLocaleDateString("en-US", { weekday: "long" })}.</p>
);
...
const ReverseAndCheckPalindrome = ({ inputString }) => {
  ...
  return (
    <p>
      ...
      {inputString === reversedString ? "It's a palindrome!" : "Not a palindrome."}
    </p>
  );
};
...
const GenerateRandomNumber = () => {
  ...
  return (
    <div>
      <button onClick={() => setRandomNum(Math.floor(Math.random() * 100) + 1)}>
        Generate Random
      </button>
